...
class ItemServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetItems = channel.unary_unary(
                ...
                response_deserializer=items__pb2.ItemList.FromString,
                _registered_method=True)
        self.CreateItem = channel.unary_unary(
                '/items.ItemService/CreateItem',
                request_serializer=items__pb2.NewItemRequest.SerializeToString,
...
def add_ItemServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetItems': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=items__pb2.ItemList.SerializeToString,
            ),
            'CreateItem': grpc.unary_unary_rpc_method_handler(
                    servicer.CreateItem,
                    request_deserializer=items__pb2.NewItemRequest.FromString,
...
class ItemService(object):
    ...
    def GetItems(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            items__pb2.ItemList.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def CreateItem(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/items.ItemService/CreateItem',
            items__pb2.NewItemRequest.SerializeToString,
